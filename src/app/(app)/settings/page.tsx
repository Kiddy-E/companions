    ...
    <div className="space-y-8 max-w-2xl">
      ...
      {session.user.role === Role.ADMIN && (
        <div className="space-y-3">
          <h2 className="text-sm font-medium text-muted-foreground uppercase tracking-wider">{t("appearance")}</h2>
          <FaviconManager hasFavicon={!!faviconSetting?.value} />
        </div>
      )}

      <div className="space-y-3">
        <h2 className="text-sm font-medium text-muted-foreground uppercase tracking-wider">{t("apiTokens")}</h2>
